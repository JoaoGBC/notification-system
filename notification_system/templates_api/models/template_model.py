...
class TemplateDb:
    ...
    updated_at: Mapped[datetime | None] = mapped_column(
        init=False, nullable=True, server_onupdate=func.now()
    )
    ...
    sms_content: Mapped[str | None] = mapped_column(
        nullable=True, default=None
    )
    generic_title_content: Mapped[str | None] = mapped_column(
        nullable=True, default=None
    )
    generic_content: Mapped[str | None] = mapped_column(
        nullable=True, default=None
    )
    context_keys_content: Mapped[list[str]] = mapped_column(
        JSON, nullable=True, default=None
    )
    context_keys_subject: Mapped[list[str]] = mapped_column(
        JSON, nullable=True, default=None
    )
