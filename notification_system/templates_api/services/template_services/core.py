...
from notification_system.templates_api.models.template_model import (
    Channel,
    TemplateDb,
)
from notification_system.templates_api.schemas.templates_schemas import (
    RegisterTemplate,
    Template,
)
...
async def register_template(
    *, template: RegisterTemplate, session: AsyncSession
) -> bool:
    """
    ...
    *,
    ...
    ids = (
        await session.execute(
            select(
                TemplateDb.id, TemplateDb.template_name, TemplateDb.channel
